      ...
      >
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          ...
          <p className="mt-2 text-xs text-justify text-gray-400">
            Exclusive discounts and heads up on new trips and experiences.
          </p>
        ...
        <div className="justify-between w-full mt-4 text-center lg:flex">
          ...
          <div className="w-full px-4 lg:w-1/3 md:w-1/2">
            ...
            <div className="flex justify-center mt-4 space-x-4 lg:mt-2">
                ...
                <Link href={""}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="black" className="bi bi-twitter-x" viewBox="0 0 16 16">
                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                  </svg>
                </Link>
                <Link href={""}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="black" className="bi bi-instagram" viewBox="0 0 16 16">
